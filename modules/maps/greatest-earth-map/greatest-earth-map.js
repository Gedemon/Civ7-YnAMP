...
function createLandmasses(iWidth, iHeight, continent1, continent2, iStartSectorRows, iStartSectorCols, startSectors) {
    ...
    for (let iY = 0; iY < iHeight; iY++) {
        for (let iX = 0; iX < iWidth; iX++) {
            ...
            //if (greatestEarth[iX][iY][0] == 16 || iY < 2 || iY > 61) {
            if (greatestEarth[iX][iY][0] == 16) {
                terrain = globals.g_OceanTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 15) {
                terrain = globals.g_CoastTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 2) {
                terrain = globals.g_MountainTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 5) {
                terrain = globals.g_MountainTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 8) {
                terrain = globals.g_MountainTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 11) {
                terrain = globals.g_MountainTerrain;
            }
            else if (greatestEarth[iX][iY][0] == 14) {
                terrain = globals.g_MountainTerrain;
            }
            ...
            console.log("createLandmasses (" + iX + "," + iY +") = " + greatestEarth[iX][iY][0] + " = " + terrain + " / " + GameplayMap.getTerrainType(iX, iY));
        }
    }
}
