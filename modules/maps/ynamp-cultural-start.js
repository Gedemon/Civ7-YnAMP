...
// completes on any standard generated map. Two options are provided:
//
...
function calculatePairScore(p1, p2, coordMap, iWidth) {
    ...
    if (GameplayMap.getLandmassRegionId(x1, y1) !== GameplayMap.getLandmassRegionId(x2, y2)) {
        actualDist += OVERSEA_PENALTY;
    }
