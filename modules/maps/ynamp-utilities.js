...
/*	Civ6 maps --------------------------------------------------- | Civ7 maps --------------------------------------------------------------------------------
	...
	0 FEATURE_ICE				0  TERRAIN_GRASS					0  FEATURE_SAGEBRUSH_STEPPE					0 BIOME_TUNDRA		0 TERRAIN_MOUNTAIN			
	1 FEATURE_JUNGLE			1  TERRAIN_GRASS_HILLS				1  FEATURE_OASIS							1 BIOME_GRASSLAND	1 TERRAIN_HILL				
	2 FEATURE_FOREST			2  TERRAIN_GRASS_MOUNTAIN			2  FEATURE_DESERT_FLOODPLAIN_MINOR			2 BIOME_PLAINS		2 TERRAIN_FLAT				
	3 FEATURE_OASIS				3  TERRAIN_PLAINS					3  FEATURE_DESERT_FLOODPLAIN_NAVIGABLE		3 BIOME_TROPICAL	3 TERRAIN_COAST				
	4 FEATURE_MARSH				4  TERRAIN_PLAINS_HILLS				4  FEATURE_FOREST							4 BIOME_DESERT		4 TERRAIN_OCEAN				
	5 FEATURE_BARRIER_REEF		5  TERRAIN_PLAINS_MOUNTAIN			5  FEATURE_MARSH							5 BIOME_MARINE		5 TERRAIN_NAVIGABLE_RIVER	
								6  TERRAIN_DESERT					6  FEATURE_GRASSLAND_FLOODPLAIN_MINOR		
...
const civ6Terrain	= ["TERRAIN_GRASS_HILLS", "TERRAIN_GRASS_MOUNTAIN", "TERRAIN_PLAINS", "TERRAIN_PLAINS_HILLS", "TERRAIN_PLAINS_MOUNTAIN", "TERRAIN_DESERT", "TERRAIN_DESERT_HILLS", "TERRAIN_DESERT_MOUNTAIN", "TERRAIN_TUNDRA", "TERRAIN_TUNDRA_HILLS", "TERRAIN_TUNDRA_MOUNTAIN", "TERRAIN_SNOW", "TERRAIN_SNOW_HILLS", "TERRAIN_SNOW_MOUNTAIN", "TERRAIN_COAST", "TERRAIN_OCEAN"];
const civ6Feature	= ["FEATURE_ICE", "FEATURE_JUNGLE", "FEATURE_FOREST","FEATURE_OASIS", "FEATURE_MARSH", "FEATURE_BARRIER_REEF"];
const civ6mountain	= ["TERRAIN_GRASS", "TERRAIN_GRASS_HILLS", "TERRAIN_GRASS_MOUNTAIN", "TERRAIN_PLAINS", "TERRAIN_PLAINS_HILLS", "TERRAIN_PLAINS_MOUNTAIN", "TERRAIN_DESERT", "TERRAIN_DESERT_HILLS", "TERRAIN_DESERT_MOUNTAIN", "TERRAIN_TUNDRA", "TERRAIN_TUNDRA_HILLS", "TERRAIN_TUNDRA_MOUNTAIN", "TERRAIN_SNOW", "TERRAIN_SNOW_HILLS", "TERRAIN_SNOW_MOUNTAIN", "TERRAIN_COAST", "TERRAIN_OCEAN"];

export function getCiv6Terrain(iTerrain) {
	return civ6Terrain[iTerrain];
}

export function getBiomeType(iCiv6Terrain) {
